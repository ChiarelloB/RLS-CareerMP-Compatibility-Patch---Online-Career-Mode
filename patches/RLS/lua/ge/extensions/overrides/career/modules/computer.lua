...
local function onSubMenuOpened()
  clearTether()
end
...
M.onPartShoppingStarted = onSubMenuOpened
M.onCareerTuningStarted = onSubMenuOpened
M.onCareerPaintingStarted = onSubMenuOpened
M.onVehiclePaintingUiOpened = onSubMenuOpened
